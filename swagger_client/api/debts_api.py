...
class DebtsApi(object):
    ...
    def schedules_schedule_d_get(self, api_key, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.schedules_schedule_d_get_with_http_info(api_key, **kwargs)  # noqa: E501
            return data
    ...
    def schedules_schedule_d_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'max_payment_period', 'sort', 'max_amount', 'min_image_number', 'creditor_debtor_name', 'min_amount_incurred', 'sort_nulls_last', 'min_payment_period', 'sort_hide_null', 'min_date', 'line_number', 'max_date', 'committee_id', 'per_page', 'min_amount', 'candidate_id', 'nature_of_debt', 'image_number', 'page', 'sort_null_only', 'max_amount_incurred', 'max_image_number']  # noqa: E501
        ...
        if ('api_key' not in params or
            ...
            raise ValueError("Missing the required parameter `api_key` when calling `schedules_schedule_d_get`")  # noqa: E501
        ...
        query_params = []
        if 'max_payment_period' in params:
            query_params.append(('max_payment_period', params['max_payment_period']))  # noqa: E501
        if 'sort' in params:
        ...
        if 'creditor_debtor_name' in params:
            query_params.append(('creditor_debtor_name', params['creditor_debtor_name']))  # noqa: E501
            collection_formats['creditor_debtor_name'] = 'multi'  # noqa: E501
        if 'api_key' in params:
            query_params.append(('api_key', params['api_key']))  # noqa: E501
        if 'min_amount_incurred' in params:
            query_params.append(('min_amount_incurred', params['min_amount_incurred']))  # noqa: E501
        if 'sort_nulls_last' in params:
            query_params.append(('sort_nulls_last', params['sort_nulls_last']))  # noqa: E501
        if 'min_payment_period' in params:
            query_params.append(('min_payment_period', params['min_payment_period']))  # noqa: E501
        ...
        if 'nature_of_debt' in params:
            query_params.append(('nature_of_debt', params['nature_of_debt']))  # noqa: E501
        ...
        if 'max_amount_incurred' in params:
            query_params.append(('max_amount_incurred', params['max_amount_incurred']))  # noqa: E501
    ...
    def schedules_schedule_d_sub_id_get(self, api_key, sub_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.schedules_schedule_d_sub_id_get_with_http_info(api_key, sub_id, **kwargs)  # noqa: E501
            return data
    ...
    def schedules_schedule_d_sub_id_get_with_http_info(self, api_key, sub_id, **kwargs):  # noqa: E501
        ...
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `schedules_schedule_d_sub_id_get`")  # noqa: E501
        # verify the required parameter 'sub_id' is set
        if ('sub_id' not in params or
                params['sub_id'] is None):
            raise ValueError("Missing the required parameter `sub_id` when calling `schedules_schedule_d_sub_id_get`")  # noqa: E501
