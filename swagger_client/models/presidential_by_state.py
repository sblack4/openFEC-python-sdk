...
class PresidentialByState(object):
    ...
    def __init__(self, candidate_id=None, contribution_receipt_amount=None, contribution_state=None, election_year=None):  # noqa: E501
        """PresidentialByState - a model defined in Swagger"""  # noqa: E501
        ...
        if contribution_state is not None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PresidentialByState, dict):
