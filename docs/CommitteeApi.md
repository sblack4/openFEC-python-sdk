...
> CommitteeDetailPage candidate_candidate_id_committees_get(api_key, candidate_id, year=year, filing_frequency=filing_frequency, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, committee_type=committee_type, sort_nulls_last=sort_nulls_last, cycle=cycle, page=page, organization_type=organization_type, sort_null_only=sort_null_only)
...
sort_null_only = False # bool | Toggle that filters out all rows having sort column that is non-null (optional) (default to False)
    ...
    try:
        api_response = api_instance.candidate_candidate_id_committees_get(api_key, candidate_id, year=year, filing_frequency=filing_frequency, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, committee_type=committee_type, sort_nulls_last=sort_nulls_last, cycle=cycle, page=page, organization_type=organization_type, sort_null_only=sort_null_only)
        pprint(api_response)
...
> CommitteeHistoryPage candidate_candidate_id_committees_history_cycle_get(api_key, cycle, candidate_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
...
sort_null_only = False # bool | Toggle that filters out all rows having sort column that is non-null (optional) (default to False)
    ...
    try:
        api_response = api_instance.candidate_candidate_id_committees_history_cycle_get(api_key, cycle, candidate_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
        pprint(api_response)
    except ApiException as e:
...
> CommitteeHistoryPage candidate_candidate_id_committees_history_get(api_key, candidate_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
...
sort_null_only = False # bool | Toggle that filters out all rows having sort column that is non-null (optional) (default to False)
    ...
    try:
        api_response = api_instance.candidate_candidate_id_committees_history_get(api_key, candidate_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
        pprint(api_response)
    except ApiException as e:
...
> CommitteeHistoryPage committee_committee_id_history_cycle_get(api_key, committee_id, cycle, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
...
sort_null_only = False # bool | Toggle that filters out all rows having sort column that is non-null (optional) (default to False)
    ...
    try:
        api_response = api_instance.committee_committee_id_history_cycle_get(api_key, committee_id, cycle, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
        pprint(api_response)
    except ApiException as e:
...
> CommitteeHistoryPage committee_committee_id_history_get(api_key, committee_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
...
sort_null_only = False # bool | Toggle that filters out all rows having sort column that is non-null (optional) (default to False)
    ...
    try:
        api_response = api_instance.committee_committee_id_history_get(api_key, committee_id, election_full=election_full, sort=sort, sort_hide_null=sort_hide_null, per_page=per_page, designation=designation, sort_nulls_last=sort_nulls_last, page=page, sort_null_only=sort_null_only)
        pprint(api_response)
    except ApiException as e:
...
# **committees_get**
> CommitteePage committees_get(api_key, year=year, max_first_file_date=max_first_file_date, sort=sort, candidate_id=candidate_id, q=q, designation=designation, committee_type=committee_type, sort_nulls_last=sort_nulls_last, organization_type=organization_type, sort_null_only=sort_null_only, filing_frequency=filing_frequency, state=state, max_last_f1_date=max_last_f1_date, sort_hide_null=sort_hide_null, per_page=per_page, party=party, min_last_f1_date=min_last_f1_date, committee_id=committee_id, page=page, cycle=cycle, min_first_file_date=min_first_file_date, treasurer_name=treasurer_name)
...
treasurer_name = ['treasurer_name_example'] # list[str] | Name of the Committee's treasurer. If multiple treasurers for the committee, the most recent treasurer will be shown. (optional)
    ...
    try:
        api_response = api_instance.committees_get(api_key, year=year, max_first_file_date=max_first_file_date, sort=sort, candidate_id=candidate_id, q=q, designation=designation, committee_type=committee_type, sort_nulls_last=sort_nulls_last, organization_type=organization_type, sort_null_only=sort_null_only, filing_frequency=filing_frequency, state=state, max_last_f1_date=max_last_f1_date, sort_hide_null=sort_hide_null, per_page=per_page, party=party, min_last_f1_date=min_last_f1_date, committee_id=committee_id, page=page, cycle=cycle, min_first_file_date=min_first_file_date, treasurer_name=treasurer_name)
        pprint(api_response)
    except ApiException as e:
