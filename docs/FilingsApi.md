...
# **operations_log_get**
> OperationsLogPage operations_log_get(api_key, report_year=report_year, beginning_image_number=beginning_image_number, min_coverage_end_date=min_coverage_end_date, sort=sort, amendment_indicator=amendment_indicator, sort_nulls_last=sort_nulls_last, sort_null_only=sort_null_only, max_transaction_data_complete_date=max_transaction_data_complete_date, max_coverage_end_date=max_coverage_end_date, report_type=report_type, form_type=form_type, per_page=per_page, sort_hide_null=sort_hide_null, min_transaction_data_complete_date=min_transaction_data_complete_date, max_receipt_date=max_receipt_date, candidate_committee_id=candidate_committee_id, min_receipt_date=min_receipt_date, page=page, status_num=status_num)
...
status_num = ['status_num_example'] # list[str] |  Status of the transactional report.     -0- Transaction is entered            into the system.           But not verified.     -1- Transaction is verified.  (optional)
    ...
    try:
        api_response = api_instance.operations_log_get(api_key, report_year=report_year, beginning_image_number=beginning_image_number, min_coverage_end_date=min_coverage_end_date, sort=sort, amendment_indicator=amendment_indicator, sort_nulls_last=sort_nulls_last, sort_null_only=sort_null_only, max_transaction_data_complete_date=max_transaction_data_complete_date, max_coverage_end_date=max_coverage_end_date, report_type=report_type, form_type=form_type, per_page=per_page, sort_hide_null=sort_hide_null, min_transaction_data_complete_date=min_transaction_data_complete_date, max_receipt_date=max_receipt_date, candidate_committee_id=candidate_committee_id, min_receipt_date=min_receipt_date, page=page, status_num=status_num)
        pprint(api_response)
    except ApiException as e:
