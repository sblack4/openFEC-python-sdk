...
api_instance = openfec_sdk.CommunicationCostApi(openfec_sdk.ApiClient(configuration))
...
try:
    api_response = api_instance.committee_committee_id_communication_costs_by_candidate_get(api_key, committee_id, per_page=per_page, cycle=cycle, sort=sort, office=office, support_oppose=support_oppose, state=state, candidate_id=candidate_id, district=district, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
...
> CommunicationCostByCandidatePage communication_costs_aggregates_get(api_key, committee_id=committee_id, per_page=per_page, cycle=cycle, sort=sort, support_oppose_indicator=support_oppose_indicator, candidate_id=candidate_id, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
...
try:
    api_response = api_instance.communication_costs_aggregates_get(api_key, committee_id=committee_id, per_page=per_page, cycle=cycle, sort=sort, support_oppose_indicator=support_oppose_indicator, candidate_id=candidate_id, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
except ApiException as e:
...
> CommunicationCostByCandidatePage communication_costs_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, office=office, support_oppose=support_oppose, state=state, candidate_id=candidate_id, district=district, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
...
try:
    api_response = api_instance.communication_costs_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, office=office, support_oppose=support_oppose, state=state, candidate_id=candidate_id, district=district, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
except ApiException as e:
...
> CommunicationCostPage communication_costs_get(api_key, sort=sort, support_oppose_indicator=support_oppose_indicator, max_amount=max_amount, min_image_number=min_image_number, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, min_date=min_date, line_number=line_number, max_date=max_date, committee_id=committee_id, per_page=per_page, min_amount=min_amount, candidate_id=candidate_id, image_number=image_number, page=page, sort_null_only=sort_null_only, max_image_number=max_image_number)
...
try:
    api_response = api_instance.communication_costs_get(api_key, sort=sort, support_oppose_indicator=support_oppose_indicator, max_amount=max_amount, min_image_number=min_image_number, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, min_date=min_date, line_number=line_number, max_date=max_date, committee_id=committee_id, per_page=per_page, min_amount=min_amount, candidate_id=candidate_id, image_number=image_number, page=page, sort_null_only=sort_null_only, max_image_number=max_image_number)
    pprint(api_response)
except ApiException as e:
...
> CCTotalsByCandidatePage communication_costs_totals_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, candidate_id=candidate_id, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
...
try:
    api_response = api_instance.communication_costs_totals_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, candidate_id=candidate_id, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
except ApiException as e:
