...
**candidate_inactive** | **bool, none_type** |  Candidates who are actively seeking office. If no value is specified, all candidates are returned. When True is specified, only active candidates are returned. When False is specified, only inactive candidates are returned.  | [optional]
...
**inactive_election_years** | **[int], none_type** | inactive years | [optional]
...
**principal_committees** | [**[committee.Committee]**](Committee.md) |  | [optional]
