...
> ScheduleEByCandidatePage schedules_schedule_e_by_candidate_get(api_key, committee_id=committee_id, per_page=per_page, cycle=cycle, sort=sort, office=office, support_oppose=support_oppose, state=state, candidate_id=candidate_id, district=district, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
...
api_instance = openfec_sdk.IndependentExpendituresApi(openfec_sdk.ApiClient(configuration))
...
support_oppose = 'support_oppose_example' # str | Support or opposition (optional)
...
try:
    api_response = api_instance.schedules_schedule_e_by_candidate_get(api_key, committee_id=committee_id, per_page=per_page, cycle=cycle, sort=sort, office=office, support_oppose=support_oppose, state=state, candidate_id=candidate_id, district=district, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
 ...
 **support_oppose** | **str**| Support or opposition | [optional]
...
> ScheduleEEfilePage schedules_schedule_e_efile_get(api_key, candidate_office_district=candidate_office_district, min_expenditure_amount=min_expenditure_amount, min_dissemination_date=min_dissemination_date, candidate_office_state=candidate_office_state, sort=sort, support_oppose_indicator=support_oppose_indicator, max_expenditure_amount=max_expenditure_amount, min_expenditure_date=min_expenditure_date, sort_nulls_last=sort_nulls_last, spender_name=spender_name, sort_hide_null=sort_hide_null, candidate_office=candidate_office, payee_name=payee_name, candidate_party=candidate_party, most_recent=most_recent, max_dissemination_date=max_dissemination_date, committee_id=committee_id, per_page=per_page, min_filed_date=min_filed_date, candidate_id=candidate_id, is_notice=is_notice, max_filed_date=max_filed_date, image_number=image_number, filing_form=filing_form, page=page, max_expenditure_date=max_expenditure_date, sort_null_only=sort_null_only, candidate_search=candidate_search)
...
try:
    api_response = api_instance.schedules_schedule_e_efile_get(api_key, candidate_office_district=candidate_office_district, min_expenditure_amount=min_expenditure_amount, min_dissemination_date=min_dissemination_date, candidate_office_state=candidate_office_state, sort=sort, support_oppose_indicator=support_oppose_indicator, max_expenditure_amount=max_expenditure_amount, min_expenditure_date=min_expenditure_date, sort_nulls_last=sort_nulls_last, spender_name=spender_name, sort_hide_null=sort_hide_null, candidate_office=candidate_office, payee_name=payee_name, candidate_party=candidate_party, most_recent=most_recent, max_dissemination_date=max_dissemination_date, committee_id=committee_id, per_page=per_page, min_filed_date=min_filed_date, candidate_id=candidate_id, is_notice=is_notice, max_filed_date=max_filed_date, image_number=image_number, filing_form=filing_form, page=page, max_expenditure_date=max_expenditure_date, sort_null_only=sort_null_only, candidate_search=candidate_search)
    pprint(api_response)
except ApiException as e:
...
> ScheduleEPage schedules_schedule_e_get(api_key, last_index=last_index, min_dissemination_date=min_dissemination_date, candidate_office_state=candidate_office_state, sort=sort, support_oppose_indicator=support_oppose_indicator, min_image_number=min_image_number, min_filing_date=min_filing_date, max_filing_date=max_filing_date, candidate_party=candidate_party, committee_id=committee_id, last_expenditure_date=last_expenditure_date, candidate_id=candidate_id, sort_null_only=sort_null_only, max_image_number=max_image_number, candidate_office_district=candidate_office_district, cycle=cycle, max_amount=max_amount, last_expenditure_amount=last_expenditure_amount, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, last_office_total_ytd=last_office_total_ytd, min_date=min_date, candidate_office=candidate_office, last_support_oppose_indicator=last_support_oppose_indicator, line_number=line_number, payee_name=payee_name, max_date=max_date, most_recent=most_recent, max_dissemination_date=max_dissemination_date, per_page=per_page, min_amount=min_amount, is_notice=is_notice, image_number=image_number, filing_form=filing_form)
...
last_support_oppose_indicator = 'last_support_oppose_indicator_example' # str |  When sorting by `support_oppose_indicator`, this is populated with the `support_oppose_indicator` of the last result. However, you will need to pass the index of that last result to `last_index` to get the next page.'  (optional)
 ...
 **last_support_oppose_indicator** | **str**|  When sorting by &#x60;support_oppose_indicator&#x60;, this is populated with the &#x60;support_oppose_indicator&#x60; of the last result. However, you will need to pass the index of that last result to &#x60;last_index&#x60; to get the next page.&#39;  | [optional]
...
> IETotalsByCandidatePage schedules_schedule_e_totals_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, candidate_id=candidate_id, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
...
try:
    api_response = api_instance.schedules_schedule_e_totals_by_candidate_get(api_key, per_page=per_page, cycle=cycle, sort=sort, candidate_id=candidate_id, election_full=election_full, page=page, sort_nulls_last=sort_nulls_last, sort_hide_null=sort_hide_null, sort_null_only=sort_null_only)
    pprint(api_response)
except ApiException as e:
