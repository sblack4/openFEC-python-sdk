...
from openfec_sdk.models import inline_response_default3
...
class LoansApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __schedules_schedule_c_get(
            self,
            api_key='DEMO_KEY',
            **kwargs
        ):
            ...
            >>> thread = api.schedules_schedule_c_get(api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                inline_response_default3.InlineResponseDefault3
        ...
        self.schedules_schedule_c_get = Endpoint(
            settings={
                'response_type': (inline_response_default3.InlineResponseDefault3,),
                'auth': [
                    'ApiKeyHeaderAuth',
                    'ApiKeyQueryAuth',
                    'apiKey'
                ],
                'endpoint_path': '/schedules/schedule_c/',
                'operation_id': 'schedules_schedule_c_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            callable=__schedules_schedule_c_get
        )

        def __schedules_schedule_c_sub_id_get(
            self,
            sub_id,
            api_key='DEMO_KEY',
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.schedules_schedule_c_sub_id_get(sub_id, api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
        ...
        self.schedules_schedule_c_sub_id_get = Endpoint(
            settings={
                'response_type': (inline_response_default3.InlineResponseDefault3,),
                'auth': [
                    'ApiKeyHeaderAuth',
                ...
                'endpoint_path': '/schedules/schedule_c/{sub_id}/',
                'operation_id': 'schedules_schedule_c_sub_id_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            api_client=api_client,
            callable=__schedules_schedule_c_sub_id_get
        )
