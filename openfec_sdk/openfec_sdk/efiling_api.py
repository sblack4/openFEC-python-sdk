...
from openfec_sdk.models import e_filings_page
from openfec_sdk.models import base_f3_filing_page
from openfec_sdk.models import base_f3_x_filing_page
from openfec_sdk.models import base_f3_p_filing_page
    ...
    def __init__(self, api_client=None):
        ...
        def __efile_filings_get(
            ...
            **kwargs
            ...
            >>> thread = api.efile_filings_get(api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
        ...
        self.efile_filings_get = Endpoint(
            settings={
                'response_type': (e_filings_page.EFilingsPage,),
                'auth': [
                    'ApiKeyHeaderAuth',
                    'ApiKeyQueryAuth',
                    'apiKey'
                ],
                'endpoint_path': '/efile/filings/',
                'operation_id': 'efile_filings_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            callable=__efile_filings_get
        )

        def __efile_reports_house_senate_get(
            self,
            api_key='DEMO_KEY',
            **kwargs
        ):
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.efile_reports_house_senate_get(api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                base_f3_filing_page.BaseF3FilingPage
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.efile_reports_house_senate_get = Endpoint(
            settings={
                'response_type': (base_f3_filing_page.BaseF3FilingPage,),
                'auth': [
                    'ApiKeyHeaderAuth',
                    'ApiKeyQueryAuth',
                    'apiKey'
                ],
                'endpoint_path': '/efile/reports/house-senate/',
                'operation_id': 'efile_reports_house_senate_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            api_client=api_client,
            callable=__efile_reports_house_senate_get
        )

        def __efile_reports_pac_party_get(
            self,
            api_key='DEMO_KEY',
            **kwargs
        ):
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.efile_reports_pac_party_get(api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                base_f3_x_filing_page.BaseF3XFilingPage
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.efile_reports_pac_party_get = Endpoint(
            settings={
                'response_type': (base_f3_x_filing_page.BaseF3XFilingPage,),
                'auth': [
                    'ApiKeyHeaderAuth',
                    'ApiKeyQueryAuth',
                    'apiKey'
                ],
                'endpoint_path': '/efile/reports/pac-party/',
                'operation_id': 'efile_reports_pac_party_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            api_client=api_client,
            callable=__efile_reports_pac_party_get
        )

        def __efile_reports_presidential_get(
            self,
            api_key='DEMO_KEY',
            **kwargs
        ):
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.efile_reports_presidential_get(api_key='DEMO_KEY', async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                base_f3_p_filing_page.BaseF3PFilingPage
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.efile_reports_presidential_get = Endpoint(
            settings={
                'response_type': (base_f3_p_filing_page.BaseF3PFilingPage,),
                'auth': [
                    'ApiKeyHeaderAuth',
                    'ApiKeyQueryAuth',
                    'apiKey'
                ],
                'endpoint_path': '/efile/reports/presidential/',
                'operation_id': 'efile_reports_presidential_get',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            api_client=api_client,
            callable=__efile_reports_presidential_get
        )
