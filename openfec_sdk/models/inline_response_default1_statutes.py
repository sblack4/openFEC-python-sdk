...
class InlineResponseDefault1Statutes(object):
    ...
    def __init__(self, chapter=None, doc_id=None, document_highlights=None, highlights=None, name=None, no=None, title=None, url=None, local_vars_configuration=None):  # noqa: E501
        """InlineResponseDefault1Statutes - a model defined in OpenAPI"""  # noqa: E501
