...
class CandidateHistory(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, candidate_id, two_year_period, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """candidate_history.CandidateHistory - a model defined in OpenAPI
