...
class ScheduleAByStateRecipientTotals(ModelNormal):
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """schedule_a_by_state_recipient_totals.ScheduleAByStateRecipientTotals - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total (float, none_type): The calculated total.. [optional]  # noqa: E501
        """
