...
class CommunicationCostByCandidate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, support_oppose_indicator, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """communication_cost_by_candidate.CommunicationCostByCandidate - a model defined in OpenAPI
