...
class ScheduleAByState(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, committee_id, cycle, state, state_full, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """schedule_a_by_state.ScheduleAByState - a model defined in OpenAPI
