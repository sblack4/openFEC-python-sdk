...
class ScheduleAByState(object):
    ...
    def __init__(self, committee_id=None, count=None, cycle=None, state=None, state_full=None, total=None, local_vars_configuration=None):  # noqa: E501
        """ScheduleAByState - a model defined in OpenAPI"""  # noqa: E501
    ...
    def state_full(self, state_full):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and state_full is None:  # noqa: E501
