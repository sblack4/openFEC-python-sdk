...
class InlineResponseDefault1Murs(object):
    ...
    def __init__(self, close_date=None, commission_votes=None, dispositions=None, doc_id=None, document_highlights=None, documents=None, election_cycles=None, highlights=None, mur_type=None, name=None, no=None, open_date=None, participants=None, respondents=None, subjects=None, url=None, local_vars_configuration=None):  # noqa: E501
        """InlineResponseDefault1Murs - a model defined in OpenAPI"""  # noqa: E501
    ...
    def mur_type(self, mur_type):
        ...
        if self.local_vars_configuration.client_side_validation and mur_type not in allowed_values:  # noqa: E501
            raise ValueError(
