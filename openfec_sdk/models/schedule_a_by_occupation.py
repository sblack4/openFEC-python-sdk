...
class ScheduleAByOccupation(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, committee_id, cycle, occupation, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """schedule_a_by_occupation.ScheduleAByOccupation - a model defined in OpenAPI
