...
class ScheduleAByZip(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, committee_id, cycle, zip, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """schedule_a_by_zip.ScheduleAByZip - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (str, none_type): US state or territory. [optional]  # noqa: E501
            state_full (str, none_type): US state or territory. [optional]  # noqa: E501
