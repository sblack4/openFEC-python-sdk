...
try:
    from openfec_sdk.models import committee
except ImportError:
    committee = sys.modules[
        'openfec_sdk.models.committee']
...
class Candidate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'inactive_election_years': ([int], none_type,),  # noqa: E501
            ...
            'principal_committees': ([committee.Committee],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'inactive_election_years': 'inactive_election_years',  # noqa: E501
        ...
        'principal_committees': 'principal_committees',  # noqa: E501
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """candidate.Candidate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            candidate_inactive (bool, none_type):  Candidates who are actively seeking office. If no value is specified, all candidates are returned. When True is specified, only active candidates are returned. When False is specified, only inactive candidates are returned. . [optional]  # noqa: E501
            ...
            inactive_election_years ([int], none_type): inactive years. [optional]  # noqa: E501
            ...
            principal_committees ([committee.Committee]): [optional]  # noqa: E501
